...
b2 = Board.create!(title: 'Project Management', owner: u1 )
b3 = Board.create!(title: 'Marketing', owner: u3)
b4 = Board.create!(title: 'App Redesign', owner: u2)
b5 = Board.create!(title: 'Bugs', owner: u7)
b6 = Board.create!(title: 'New Website', owner: u8)
b7 = Board.create!(title: 'Product Roadmap', owner: u9)
